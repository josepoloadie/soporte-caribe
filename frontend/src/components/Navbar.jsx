  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
        ...
        {/* Menú escritorio */}
        <ul className="hidden md:flex space-x-6 items-center text-white font-medium text-sm">
          <li>
          ...
          <li>
            <Link
              to="/login"
              className="bg-white text-[var(--color-primary)] px-4 py-1.5 rounded-md font-semibold hover:bg-gray-100 transition"
            >
              Iniciar sesión
            </Link>
          </li>
          ...
          <ul className="space-y-4 text-base">
            ...
            <li>
              <Link
                to="/login"
                onClick={toggleMenu}
                className="inline-block w-full text-center bg-white text-[var(--color-primary)] px-4 py-2 rounded-md font-semibold hover:bg-gray-100 transition"
              >
                Iniciar sesión
              </Link>
            </li>
